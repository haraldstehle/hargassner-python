...
-- Generate the database structure for Hargassner
CREATE DATABASE IF NOT EXISTS `Hargassner` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `Hargassner`;


-- Generate the table structure of Hargassner.data
